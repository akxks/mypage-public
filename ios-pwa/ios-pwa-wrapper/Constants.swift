...
let appTitle = "mypage"
let webAppUrl = URL(string: "http://192.168.0.13/social-media-project/htdocs/home")
let allowedOrigin = "192.168.0.13" //192.168.0.13
...
let navigationBarColor = getColorFromHex(hex: 0xFF2449, alpha: 1.0)
