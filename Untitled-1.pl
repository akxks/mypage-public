                           ...
                           <div> 
                           <br>
                           <h2 style='margin:30px;'> Complete registration 🔑 </h2 >
                           ...
                           You created an account with us. To continue and finish the process, press the button below.
                           If this was not you, please ignore this email. 
                           
                           <center> 
                           
                           <a href='mypage.com/verify?t=".$tokenGenerated."'> 
