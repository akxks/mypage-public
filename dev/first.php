...
function loadSpin() { 
  ...
  document.getElementById("idInputButton").style.display = "none"; 
...
$(document).ready(function(){ 
  ...
  <div class="main width-center noselect" style = "margin-top:20px;width: auto;overflow: hidden;border: 0px solid red; padding-top:20px; cursor: default;"> 
  ...
  <div class="column" id="statis1" style="width: 50%; border: 0px solid red; display:none;"> 
      ...
      <div style='  float: right;
          ...
          <p style='font-size:30px;'>- <br> <b> Site Views </b></p> 
        ...
        <p style='font-size:30px;'>- <br> <b> Featured Creators </b></p> 
      ...
      <div style='  float: right;
          ...
          <p style='font-size:30px;'>- <br> <b> Paid Out </b></p> 
...
<div class="column" id="statis2" style="width: 50%; border: 0px solid red; display:none;"> 
  ...
  <div style='  float: right;
      ...
      <p style='font-size:30px;'>- <br> <b> Superlikes </b></p> 
...
<div style=" position:fixed; padding:0; margin:0; top:0; left:0; width: 100%; height: 100%; ;background-image: linear-gradient(#ff3b5c, #de1641); overflow-y: scroll; "> 
    ...
    <div class="column " style="float:right;display: inline; max-width:400px; overflow-y: scroll;">
          <div class="form" style="width:100%;height:100%; overflow-y: scroll;" > 
            <?php include 'api/login.php';?> 
            <center> <p style="font-size:19px; color: white !important;"> Your password is end-to-end encrypted 🔒 </center> 
          </div> 
        </div>
    </div> 
</div>  
