...
<?php  
  ...
  <div id="superPost" style="display:none;" class="modal">  
    <div id="superPostBox" class="modal-content internetOffline internetOfflineText" style="max-width:650px !important;"> 
     <h2 style="text-shadow: 0px 0px 13px rgba(255, 0, 0, 0.9) !important;display:inline;"> ❤️ <h2 style="display:inline;"> Superlike '.$firstnamePerson.'\'s post </h2>  
     <p> By superliking a creators post, you are donating to them and supporting them. You can superlike a post by donating a set amount made by the creator with a connected payment option. </p>

     <form name="sharing" action="api/superPost" method="post">
