<?php
$lang_core_friends_makefriends = "Haz Amigos";
$lang_core_index_trending = "Tendencias 🔥";
$lang_core_index_publicrooms = "Salas Públicas";
$lang_core_index_friends = "Amigos";
$lang_core_index_suggestedfriends = "Amigos Sugeridos";
$lang_core_index_posts = "Posts";

$lang_core_profile_notexist = " 🚫 Esta cuenta no existe ";

$lang_core_searchpage_search = "Buscar";

$lang_core_about_editedlast = "Edited 2021/03 · MyPage © 2021";
$lang_core_language_displaylang = " 🌎 Idioma de la pantalla ";
$lang_core_about_about = "Acerca de";
$lang_core_about_about_desc = "Red social creada por Adrian.";
$lang_core_about_support = "Soporte";
$lang_core_about_support_desc = "Para obtener soporte, contactar support@mypage.com";
$lang_core_about_new = "Que hay de nuevo";
$lang_core_about_new_desc = "Idiomas";
$lang_core_about_safety = "Seguridad";
$lang_core_about_safety_desc = "Puedes bloquear personas.";
$lang_core_about_privacy = "Privacidad";
$lang_core_about_privacy_desc = "Encriptamos tus datos para que esten seguros.";
$lang_core_about_terms = "Terminos";
$lang_core_about_terms_desc = "Terminos y condiciones placeholder.";
$lang_core_about_cookies = "Cookies";
$lang_core_about_cookies_desc = "Usamos cookies, como Auto Login, para que tu experiencia con nuestro sitio sea mejor.";

$lang_core_settings_title = "Ajustes";
$lang_core_settings_desc = "Administra tus ajustes aquí.";
$lang_core_settings_account = "👤 Cuenta";
$lang_core_settings_privacy = "🔒 Privacidad"; 
$lang_core_settings_appearance = "🦋 Apariencia"; 
$lang_core_settings_blockedusers = "🚫 Usuarios Bloqueados";
$lang_core_settings_blockedwords = "🚫 Palabras Bloqueadas";
$lang_core_settings_notifications = "🔔 Notificaciones";
$lang_core_settings_features = "🛠 Características";
//
$lang_core_settings_account_title = "Cuenta";
$lang_core_settings_account_desc = " ";
$lang_core_settings_privacy_title = "Privacidad";
$lang_core_settings_privacy_desc = " ";
$lang_core_settings_appearance_title = "Apariencia";
$lang_core_settings_appearance_desc = " ";
$lang_core_settings_blockedusers_title = "Usuarios Bloqueados"; 
$lang_core_settings_blockedusers_desc = " "; 
$lang_core_settings_blockedwords_title = "Palabras Bloqueadas";
$lang_core_settings_blockedwords_desc = " ";
$lang_core_settings_notifs_title = "Notificaciones";
$lang_core_settings_notifs_desc = " ";
$lang_core_settings_features_title = "Caracteristicas";
$lang_core_settings_features_desc = " ";
$lang_core_index_posts = "Publicaciones";

$lang_core_settings_changeprivacy = " Cambia tu perfil a público o privado "; 
//

$lang_core_settings_on = "Activado";
$lang_core_settings_off = "Desactivado";

$lang_just_now = "ahora mismo";

$lang_about_about = "Acerca de";
$lang_about_support = "Suporte";
$lang_about_safety = "Seguridad";
$lang_about_privacy = "Privacidad";
$lang_about_terms = "Terminos";
$lang_about_cookies = "Cookies";
$lang_about_copyright = "· MyPage © 2021 ";

$lang_fetch_blocked_none = "💭 No has bloqueado a nadie todavia."; 

$lang_fetch_invites_header_reach_limit = "Invitar Amigos • 0 Restantes";
$lang_fetch_invites_header = "Invitar Amigos • ";
$lang_fetch_invites_header2 = "restante(s)"; 
$lang_fetch_invites_desc_reach_limit = "Haz alcanzado el limite de 20 invitaciones. Por favor vuelve despues para invitar a mas gente."; 
$lang_fetch_invites_desc = "Mypage invite-only right now, asi que asegurate de generar codigos de invitacion para tus amigos.  ";  
$lang_fetch_invites_usedby = " Usado por ";  
$lang_fetch_invites_unused = " Codigo sin usar ";

$lang_friends_fetch_cantseetheirfriends = "🔒 No puedes ver sus amigos. ";
$lang_friends_fetch_nofriendsfound = "🚫 No se encontraron amigos ";
$lang_friends_fetch_you = " Tu ";
$lang_friends_fetch_friend = " amigo";

$lang_get_profile_actions = " Acciones ";
$lang_get_profile_actions_remove_friend = " ❌ Eliminar amigo  ";
$lang_get_profile_actions_block_friend = " 🚫 Bloquear  ";
$lang_get_profile_actions_love_friend = " ❤️ Solicitud de amor ";
$lang_get_profile_actions_wave_friend = " 👋 Saludar ";
$lang_get_profile_actions_message_friend = " 💬 Enviar mensaje ";
$lang_get_profile_edit = "Editar"; 
$lang_get_profile_add_friend = "Añadir Amigo";
$lang_get_profile_delete_friend = "Eliminar Amigo";
$lang_get_profile_add_request = "Añadir";
$lang_get_profile_deny_request = "Rechazar";
$lang_get_profile_requested = "Solicitado";
$lang_get_profile_your_info = "Tu Información ";
$lang_get_profile_info = "Información ";
$lang_get_profile_thisaccount_isprivate = "🔒 Esta cuenta es privada ";
$lang_get_profile_joined = " 💭 Se unió ";
$lang_get_profile_birthday = " Cumpleaños ";
$lang_get_profile_location = " 🌎 Localización ";
$lang_get_profile_privateaccount = " 🔒 Cuenta Privada ";
$lang_get_profile_yourfriends = "Tus Amigos • ";
$lang_get_profile_theirfriends = "Sus Amigos • ";
$lang_get_profile_theirfriendsnodot = "Sus Amigos ";
$lang_get_profile_incommon1 = " Tienen ";
$lang_get_profile_incommon2 = " amigos en comun. ";
$lang_get_profile_noneincommon = " No tienen amigos en comun. ";
$lang_get_profile_yourposts = "Tus Publicaciones • ";
$lang_get_profile_posts = "Publicaciones • ";
$lang_get_profile_postsnodot = "Publicaciones ";
$lang_get_profile_likedposts = "Publicaciones que te gustan";

$lang_fetch_invites_generatecode = "Generar un Código ✉️";

$lang_header_notifications = "Notificaciones •";
$lang_header_msgs = "Mensajes • "; 
$lang_header_friendsreqs = "Solicitudes de amistad •";
$lang_header_search = " Buscar";
$lang_header_search_users = "usuarios";
$lang_header_dropdown_settings = "⚙️ Ajustes ";
$lang_header_dropdown_findfriends = "🍀 Encontrar Amigos";
$lang_header_dropdown_language = "🌍 Idioma ";
$lang_header_dropdown_logout = "🚪 Cerrar Sesión ";
$lang_header_head_home = "Inicio" ;
$lang_header_head_invite = "Invitación" ;
$lang_header_head_more = "Más";

$lang_header_new_signin = " Iniciar sesión ";
$lang_header_new_signup = " Registrarse ";

$lang_internetalive1 = "Oh oh... 🔌";
$lang_internetalive2 = "Estas desconectado, revisa tu conexión a internet. ";
$lang_internetalive3 = "Esperamos verte pronto. ";

$lang_notifsfetch_none = " 💭 No se encontraron notificaciones "; 

$lang_post_whatwouldulike = "Que te gustaria publicar, ";
$lang_post_upload = "Publicar";
$lang_post_addloc = "🌎 Añadir Localización ";

$lang_postfetch_nomoremakefriend = " 💭 No se encontraron más publicaciones! Haz nuevos amigos y encuentra más.";
$lang_postfetch_nonefound = " 💭 No se encontraron más publicaciones. ";

$lang_requestsfetch_nofound = " 💭 No se encontraron solicitudes ";

$lang_searchajax_friend = " Amigo ";
$lang_searchajax_viewmore = " Ver "; 
$lang_searchajax_viewmore2 = " mas resultados... ";

$lang_suggestedfriends_nosuggestions = " 💭 No pudimos encontrar mas sugerencias en este momento. ";
