<?php 
         $lang_core_friends_makefriends = "Adauga Prieteni";
         $lang_core_index_trending = "Trending";
         $lang_core_index_publicrooms = "Camera Publica";
         $lang_core_index_friends = "Prieteni";
         $lang_core_index_suggestedfriends = "Poate îi cunoşti";
         $lang_core_index_posts = "Postări";

         $lang_core_profile_notexist = " 🚫 Acest cont nu exisăt ";

         $lang_core_searchpage_search = "Căutare";

         $lang_core_about_editedlast = "Editat 2021/03 · MyPage © 2021";

         $lang_core_about_about = "Despre website";
         $lang_core_about_about_desc = "Websiteul creat de Adrian.";
         $lang_core_about_support = "Ajutor";
         $lang_core_about_support_desc = "Pentru ajutor, contactati support@mypage.com";
         $lang_core_about_new = "Ce este nou";
         $lang_core_about_new_desc = "Limbi";
         $lang_core_about_safety = "Siguranță";
         $lang_core_about_safety_desc = "Blocați pe cineva.";
         $lang_core_about_privacy = "Confidenţialitate";
         $lang_core_about_privacy_desc = " Acest site foloseste criptare, datele dvs. sunt sigure.";
         $lang_core_about_terms = "Termeni";
         $lang_core_about_terms_desc = "Termeni si condiții al substituentului.";
         ...
         $lang_core_settings_title = "Setari";
         $lang_core_settings_desc = "Setari ale contului.";
         $lang_core_settings_account = "👤 Cont";
         $lang_core_settings_privacy = "🔒 Confidenţialitate"; 
         $lang_core_settings_appearance = "🦋 Apariţie"; 
         $lang_core_settings_blockedusers = "🚫 Persoane Blocate";
         $lang_core_settings_blockedwords = "🚫 Cuvinte Blocate";
         $lang_core_settings_notifications = "🔔 Notificari";
         $lang_core_settings_features = "🛠 Caracteristici";
         //
         $lang_core_settings_account_title = "Cont";
         $lang_core_settings_account_desc = " ";
         $lang_core_settings_privacy_title = "Confidenţialitate";
         $lang_core_settings_privacy_desc = " ";
         $lang_core_settings_appearance_title = "Caracteristici";
         $lang_core_settings_appearance_desc = " ";
         $lang_core_settings_blockedusers_title = "Persoane Blocate"; 
         $lang_core_settings_blockedusers_desc = " "; 
         $lang_core_settings_blockedwords_title = "Cuvinte Blocate";
         $lang_core_settings_blockedwords_desc = " ";
         $lang_core_settings_notifs_title = "Notificari";
         $lang_core_settings_notifs_desc = " ";
         $lang_core_settings_features_title = "Caracteristici";
         $lang_core_settings_features_desc = " ";

         $lang_core_settings_changeprivacy = " Schimba contul din privat in public "; 
         //

         $lang_core_settings_on = "Pornit";
         $lang_core_settings_off = "Oprit";

         $lang_just_now = "Acum";

         $lang_about_about = "Depre";
         $lang_about_support = "Ajutor";
         $lang_about_safety = "Siguranță";
         $lang_about_privacy = "Confidenţialitate";
         $lang_about_terms = "Termeni";
         $lang_about_cookies = "Cookies";
         $lang_about_copyright = "· MyPage © 2021 ";

         $lang_fetch_blocked_none = "💭 Nu ați blocate pe nimeni."; 

         $lang_fetch_invites_header_reach_limit = "Invita Prieteni • 0 ramsi";
         $lang_fetch_invites_header = "Invita Prieteni • ";
         $lang_fetch_invites_header2 = "ramasi"; 
         $lang_fetch_invites_desc_reach_limit = "Ati ajuns la limita de 20 de persoane invitate. Va rugam sa va intoarceti mai tarziu sa invitati mai multe persoane."; 
         ...
         $lang_fetch_invites_usedby = " Cod folosit de ";  
         $lang_fetch_invites_unused = " Cod nefolosi ";

         $lang_friends_fetch_cantseetheirfriends = "🔒 Nu puteti vedea lista de prieteni. ";
         $lang_friends_fetch_nofriendsfound = "🚫 Niciun prieten gasit ";
         $lang_friends_fetch_you = " Eu ";
         $lang_friends_fetch_friend = "Mai multi prieteni ";

         $lang_get_profile_actions = " Meniu ";
         $lang_get_profile_actions_remove_friend = " ❌ Sterge Prieten  ";
         $lang_get_profile_actions_block_friend = " 🚫 Blocheaza  ";
         $lang_get_profile_actions_love_friend = " ❤️ Cerere de dragoste ";
         $lang_get_profile_actions_wave_friend = " 👋 Gest ";
         $lang_get_profile_actions_message_friend = " 💬 Mesaj ";
         $lang_get_profile_edit = "Modify"; 
         $lang_get_profile_add_friend = "Adauga Prieten";
         $lang_get_profile_delete_friend = "Sterge Prieten";
         $lang_get_profile_add_request = "Adauga";
         $lang_get_profile_deny_request = "Refuza";
         $lang_get_profile_requested = "Cerere";
         $lang_get_profile_your_info = "Informatile Tale ";
         $lang_get_profile_info = "Informati ";
         $lang_get_profile_thisaccount_isprivate = "🔒 Acest cont este privat ";
         $lang_get_profile_joined = " 💭 S-a alăturat ";
         $lang_get_profile_birthday = " Zi de nastere ";
         $lang_get_profile_location = " 🌎 Locatie ";
         $lang_get_profile_privateaccount = " 🔒 Cont Privat ";
         $lang_get_profile_yourfriends = "Prietenii tai • ";
         $lang_get_profile_theirfriends = "Prietenii lor • ";
         $lang_get_profile_theirfriendsnodot = "Prietenii lor ";
         $lang_get_profile_incommon1 = " Tu ai ";
         $lang_get_profile_incommon2 = " prieteni ni comun. ";
         $lang_get_profile_noneincommon = " Nu aveti prieteni in comun. ";
         $lang_get_profile_yourposts = "Postarile tale • ";
         $lang_get_profile_posts = "Postari • ";
         $lang_get_profile_postsnodot = "Postari ";

         $lang_header_notifications = "Notificari •";
         $lang_header_msgs = "Mesaje • "; 
         $lang_header_friendsreqs = "Cerere de preteni •";
         $lang_header_search = " Cauta ";
         $lang_header_search_users = "utilizatori ";
         $lang_header_dropdown_settings = "⚙️ Setari ";
         $lang_header_dropdown_findfriends = "🍀 Cauta Prieteni";
         $lang_header_dropdown_language = "🌍 Limba ";
         $lang_header_dropdown_logout = "🚪 Deconectare ";

         $lang_header_new_signin = " Conectare ";
         $lang_header_new_signup = " Inscrie-te ";

         $lang_internetalive1 = "Oh-oh... 🔌";
         $lang_internetalive2 = "Esti offline ,verifica conexiuna de internet. ";
         $lang_internetalive3 = "Sper sa te vad curand. ";

         $lang_notifsfetch_none = " 💭 Nici-o notificare gasita "; 

         $lang_post_whatwouldulike = "Ce ai vrea sa postezi, ";
         $lang_post_upload = "Upload";
         $lang_post_addloc = "🌎 Adauga locatie ";

         $lang_postfetch_nomoremakefriend = " 💭 Nici o postare gasita! Gaseste prieteni noi.";
         $lang_postfetch_nonefound = " 💭 Nici o postare gasita. ";
         
         $lang_requestsfetch_nofound = " 💭 Nici o cerere gasita ";

         $lang_searchajax_friend = " Prieten ";
         $lang_searchajax_viewmore = " Arata inca 5 utilizatori "; 
         $lang_searchajax_viewmore2 = " mai multi utilizatori... ";

         $lang_suggestedfriends_nosuggestions = " 💭 Nu am gasit alti utilizatori recomandati. ";
