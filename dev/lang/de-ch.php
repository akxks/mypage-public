<?php
$lang_core_html_titles_search = "Suche";
$lang_core_html_titles_friends = "Freunde";
$lang_core_html_titles_index = "Startseite";
$lang_core_html_titles_invite = "Einladungen";
$lang_core_html_titles_language = "Sprachen";
$lang_core_html_titles_profile = "Profil";
$lang_core_html_titles_settings = "Einstellungen";
$lang_core_html_titles_about = "Über";

$lang_core_friends_makefriends = "Freunde finden";

$lang_core_index_trending = "Trend 🔥";
$lang_core_index_trending_desc = "Aktuell trending:";
$lang_core_index_publicrooms = "Öffentliche Räume";
$lang_core_index_friends = "Freunde";
$lang_core_index_suggestedfriends = "Vorgeschlagene Freunde";
$lang_core_index_posts = "Beiträge";

$lang_core_profile_notexist = " 🚫 Dieses Konto existiert nicht ";

$lang_core_searchpage_search = "Suche";

$lang_core_about_editedlast = "Bearbeitet 2021/03 - MyPage © 2021";

$lang_core_about_about = "Über";
$lang_core_about_about_desc = "Soziale Medien, erstellt von Adrian.";
$lang_core_about_support = "Unterstützung";
$lang_core_about_support_desc = "Für Support, kontaktieren Sie support@mypage.com";
$lang_core_about_new = "Was ist neu";
$lang_core_about_new_desc = "Sprachen";
$lang_core_about_safety = "Sicherheit";
$lang_core_about_safety_desc = "Sie können Leute blockieren";
$lang_core_about_privacy = "Datenschutz";
$lang_core_about_privacy_desc = "Wir verwenden Verschlüsselung, damit Ihre Daten sicher sind.";
$lang_core_about_terms = "Bedingungen";
$lang_core_about_terms_desc = "Platzhalter für die Allgemeinen Geschäftsbedingungen";
$lang_core_about_cookies = "Cookies";
$lang_core_about_cookies_desc = "Wir verwenden essentielle Cookies, wie z.B. Auto-Login, um Ihre Erfahrung mit der Website gut zu halten.";

$lang_core_settings_title = "Einstellungen";
$lang_core_settings_desc = "Hier können Sie Einstellungen verwalten.";
$lang_core_settings_account = "👤 Konto";
$lang_core_settings_privacy = "🔒 Datenschutz"; 
$lang_core_settings_appearance = "🦋 Erscheinungsbild"; $lang_core_settings_appearance = "🦋 Erscheinungsbild"; 
$lang_core_settings_blockedusers = "🚫 Gesperrte Benutzer"; $lang_core_settings_blockedusers = "🚫 Gesperrte Benutzer";
$lang_core_settings_blockedwords = "🚫 Gesperrte Wörter"; $lang_core_settings_blockedwords = "🚫 Gesperrte Wörter";
$lang_core_settings_notifications = "🔔 Benachrichtigungen"; $lang_core_settings_notifications = "🔔 Benachrichtigungen";
$lang_core_settings_features = "🛠 Merkmale"; $lang_core_settings_features = "🛠 Merkmale";

$lang_core_settings_account_title = "Konto";
$lang_core_settings_account_desc = "Hier sehen Sie Ihre Kontoeinstellungen. ";
$lang_core_settings_privacy_title = "Datenschutz";
$lang_core_settings_privacy_desc = "Hier können Sie Ihre Privatsphäre-Einstellungen einsehen. ";
$lang_core_settings_appearance_title = "Erscheinungsbild";
$lang_core_settings_appearance_desc = "Hier können Sie Ihre Einstellungen zum Erscheinungsbild einsehen.";
$lang_core_settings_blockedusers_title = "Gesperrte Benutzer"; 
$lang_core_settings_blockedusers_desc = "Hier können Sie Ihre blockierten Benutzer anzeigen."; 
$lang_core_settings_blockedwords_title = "Gesperrte Wörter";
$lang_core_settings_blockedwords_desc = "Hier werden die blockierten Wörter angezeigt.";
$lang_core_settings_notifs_title = "Benachrichtigungen";
$lang_core_settings_notifs_desc = "Hier werden die Einstellungen für Benachrichtigungen angezeigt.";
$lang_core_settings_features_title = "Funktionen";
$lang_core_settings_features_desc = "Hier können Sie die Einstellungen für Funktionen anzeigen.";

$lang_core_settings_changeprivacy = "Ändern Sie Ihr Profil auf privat oder öffentlich"; 
$lang_core_settings_changeprivacy_on = " Zu einem privaten Profil wechseln "; 
$lang_core_settings_changeprivacy_off = " Auf ein öffentliches Profil umschalten "; 

$lang_core_language_displaylang = " 🌎 Anzeigesprache "; 

$lang_core_settings_on = "Ein";
$lang_core_settings_off = "Aus"; $lang_core_settings_off = "Aus";

// Kern Ende

$lang_just_now = "gerade jetzt";

$lang_about_about = "Über";
$lang_about_support = "Unterstützung";
$lang_about_safety = "Sicherheit";
$lang_about_privacy = "Datenschutz";
$lang_about_terms = "Bedingungen";
$lang_about_cookies = "Cookies";
$lang_about_copyright = "- MyPage © 2021 ";

$lang_fetch_blocked_none = "💭 Sie haben noch niemanden blockiert."; 

$lang_fetch_invites_header_reach_limit = "Freunde einladen - 0 übrig";
$lang_fetch_invites_header = "Freunde einladen - ";
$lang_fetch_invites_header2 = "links"; 
$lang_fetch_invites_desc_reach_limit = "Sie haben das Einladungslimit von 20 erreicht. Bitte kommen Sie später wieder und laden Sie weitere Personen ein."; 
$lang_fetch_invites_desc = "Die Seite ist im Moment einladungsbeschränkt, also stellen Sie sicher, dass Sie Einladungscodes für Ihre Freunde generieren, damit Sie sie einladen können.  ";  
$lang_fetch_invites_usedby = " Verwendet von "; 
$lang_fetch_invites_unused = " Code unbenutzt ";
$lang_fetch_invites_generatecode = "Einen Code generieren ✉️";

$lang_friends_fetch_cantseetheirfriends = "🔒 Sie können ihre Freunde nicht sehen. ";
$lang_friends_fetch_nofriendsfound = "🚫 Keine Freunde gefunden ";
$lang_friends_fetch_you = " Sie ";
$lang_friends_fetch_friend = "Freund";

$lang_get_profile_actions = " Aktionen ";
$lang_get_profile_actions_remove_friend = " ❌ Freund entfernen ";
$lang_get_profile_actions_block_friend = " 🚫 Blockieren ";
$lang_get_profile_actions_love_friend = " ❤️ Liebesanfrage ";
$lang_get_profile_actions_wave_friend = " 👋 Welle ";
$lang_get_profile_actions_message_friend = " 💬 Nachricht ";
$lang_get_profile_edit = "Bearbeiten"; 
$lang_get_profile_add_friend = "Freund hinzufügen";
$lang_get_profile_delete_friend = "Freund löschen";
$lang_get_profile_add_request = "Hinzufügen";
$lang_get_profile_deny_request = "Ablehnen";
$lang_get_profile_requested = "Anfordern";
$lang_get_profile_your_info = "Ihre Info";
$lang_get_profile_info = "Info ";
$lang_get_profile_thisaccount_isprivate = "🔒 Dieses Konto ist privat ";
$lang_get_profile_joined = " 💭 Joined ";
$lang_get_profile_birthday = " Geburtstag ";
$lang_get_profile_location = " 🌎 Ort ";
$lang_get_profile_privateaccount = " 🔒 Privatkonto ";
$lang_get_profile_yourfriends = "Deine Freunde - ";
$lang_get_profile_theirfriends = "Ihre Freunde - ";
$lang_get_profile_theirfriendssnodot = "Ihre Freunde ";
$lang_get_profile_incommon1 = "Sie haben ";
$lang_get_profile_incommon2 = " Gemeinsame Freunde. ";
$lang_get_profile_noneincommon = " Sie haben keine gemeinsamen Freunde. ";
$lang_get_profile_yourposts = "Ihre Beiträge - ";
$lang_get_profile_posts = "Beiträge - ";
$lang_get_profile_postsnodot = "Beiträge - ";
$lang_get_profile_likedposts = "Geliebte Beiträge";

$lang_header_notifications = "Benachrichtigungen - ";
$lang_header_msgs = "Nachrichten - "; 
$lang_header_friendsreqs = "Freundschaftsanfragen - ";
$lang_header_search = "Suche - ";
$lang_header_search_users = "Benutzer";
$lang_header_dropdown_settings = "⚙️ Einstellungen ";
$lang_header_dropdown_findfriends = "🍀 Freunde finden";
$lang_header_dropdown_language = "🌍 Sprache ";
$lang_header_dropdown_logout = "🚪 Abmelden ";
$lang_header_head_home = "Home" ;
$lang_header_head_invite = "Einladen" ;
$lang_header_head_more = "Mehr";

$lang_header_new_signin = "Anmelden";
$lang_header_new_signup = " Anmelden ";

$lang_internetalive1 = "Uh oh... 🔌";
$lang_internetalive2 = "Sie sind offline, überprüfen Sie Ihre Internetverbindung. ";
$lang_internetalive3 = "Hoffe, Sie bald zu sehen. ";

$lang_notifsfetch_none = " 💭 Keine Benachrichtigungen gefunden "; 

$lang_post_whatwouldulike = "Was würden Sie gerne posten, ";
$lang_post_upload = "Hochladen";
$lang_post_addloc = "🌎 Ort hinzufügen ";

$lang_postfetch_theirpostsareprivate = " 🔒 Ihre Beiträge sind privat. Fügen Sie sie zuerst als Freund hinzu. ";
$lang_postfetch_nomoremakefriend = " 💭 Keine weiteren Beiträge gefunden! Füge neue Freunde hinzu und finde mehr.";
$lang_postfetch_nonefound = " 💭 Keine weiteren Beiträge gefunden. ";

$lang_requestsfetch_nofound = " 💭 Keine Anfragen gefunden ";

$lang_searchajax_friend = " Freund ";
$lang_searchajax_viewmore = " Ansicht "; 
$lang_searchajax_viewmore2 = " mehr Ergebnisse... ";

$lang_suggestedfriends_nosuggestions = " 💭 Konnte im Moment keine Vorschläge finden. ";
