<?php
$lang_core_html_titles_search = "搜索";
$lang_core_html_titles_friends = "好友";
$lang_core_html_titles_index = "主页";
$lang_core_html_titles_invite = "邀请";
$lang_core_html_titles_language = "语言";
$lang_core_html_titles_profile = "个人资料";
$lang_core_html_titles_settings = "设置";
$lang_core_html_titles_about = "关于";

$lang_core_friends_makefriends = "找好友";

$lang_core_index_trending = "热门 🔥";
$lang_core_index_trending_desc = "目前最热:";
$lang_core_index_publicrooms = "共享空间 (edit?)";
$lang_core_index_friends = "好友";
$lang_core_index_suggestedfriends = "最合适你的好友 (edit?)";
$lang_core_index_posts = "帖子";

$lang_core_profile_notexist = " 🚫 这个账号并不存在 ";

$lang_core_searchpage_search = "搜索";

$lang_core_about_editedlast = "已编辑 2021/03 · 我的页面/MyPage © 2021";

$lang_core_about_about = "关于";
$lang_core_about_about_desc = "Adrian/阿德里安 建造的社交平台.";
$lang_core_about_support = "帮助";
$lang_core_about_support_desc = "如要帮助, 请联系 support@mypage.com";
$lang_core_about_new = "最新";
$lang_core_about_new_desc = "语言";
$lang_core_about_safety = "安全";
$lang_core_about_safety_desc = "你可以拉黑用户 (edit?).";
$lang_core_about_privacy = "隐私";
$lang_core_about_privacy_desc = "我们使用加密来保护您的数据.";
$lang_core_about_terms = "条款";
$lang_core_about_terms_desc = "合约条款";
$lang_core_about_cookies = "数据饼";
$lang_core_about_cookies_desc = "我们会使用交换数据（数据饼）使您的使用体验更为舒适。例如：我们的自动登录功能.";

$lang_core_settings_title = "设置";
$lang_core_settings_desc = "设置管理.";
$lang_core_settings_account = "👤 账号";
$lang_core_settings_privacy = "🔒 隐私"; 
$lang_core_settings_appearance = "🦋 外观"; 
$lang_core_settings_blockedusers = "🚫 黑名单";
$lang_core_settings_blockedwords = "🚫 屏蔽词 (edit?)(this word appears many times through out this code)";
$lang_core_settings_notifications = "🔔 通知";
$lang_core_settings_features = "🛠 功能";

$lang_core_settings_account_title = "账号";
$lang_core_settings_account_desc = "账号设置. ";
$lang_core_settings_privacy_title = "隐私";
$lang_core_settings_privacy_desc = "隐私设置. ";
$lang_core_settings_appearance_title = "外观";
$lang_core_settings_appearance_desc = "账号外观设置.";
$lang_core_settings_blockedusers_title = "黑名单"; 
$lang_core_settings_blockedusers_desc = "黑名单录."; 
$lang_core_settings_blockedwords_title = "屏蔽词";
$lang_core_settings_blockedwords_desc = "屏蔽词录.";
$lang_core_settings_notifs_title = "通知";
$lang_core_settings_notifs_desc = "通知设置.";
$lang_core_settings_features_title = "功能";
$lang_core_settings_features_desc = "功能设置.";

$lang_core_settings_changeprivacy = " 个人资料设定改为私人或公开 "; 
$lang_core_settings_changeprivacy_on = " 改为私人  "; 
$lang_core_settings_changeprivacy_off = " 改为公开  "; 

$lang_core_language_displaylang = " 🌎 显示语言 "; 

$lang_core_settings_on = "开";
$lang_core_settings_off = "关";
...
$lang_about_about = "关于";
$lang_about_support = "帮助";
$lang_about_safety = "安全";
$lang_about_privacy = "隐私";
$lang_about_terms = "条款";
$lang_about_cookies = "数据饼";
$lang_about_copyright = "· 我的页面／MyPage © 2021 ";

$lang_fetch_blocked_none = "💭 您并没有拉黑任何用户."; 

$lang_fetch_invites_header_reach_limit = "邀请好友 • 剩下 0 个";
$lang_fetch_invites_header = "邀请好友 • ";
$lang_fetch_invites_header2 = "剩下(left over)"; 
$lang_fetch_invites_desc_reach_limit = "您已经达到20个用户的邀请极限。请稍后再回来邀请其他用戶."; 
$lang_fetch_invites_desc = "我的页面／Mypage 现为邀请模式, 请生成邀请码以便邀请您的朋友.  ";  
$lang_fetch_invites_usedby = " 由(insert subject here)使用 "; 
$lang_fetch_invites_unused = " 代码未被使用 ";
$lang_fetch_invites_generatecode = "生成代码 ✉️";

$lang_friends_fetch_cantseetheirfriends = "🔒 您无法观看这位用户的好友列表. ";
$lang_friends_fetch_nofriendsfound = "🚫 无法找到好友 ";
$lang_friends_fetch_you = " 你 ";
$lang_friends_fetch_friend = " 朋友";

$lang_get_profile_actions = " 行动 ";
$lang_get_profile_actions_remove_friend = " ❌ 移除好友  ";
$lang_get_profile_actions_block_friend = " 🚫 拉黑  ";
$lang_get_profile_actions_love_friend = " ❤️ 情书 ";
$lang_get_profile_actions_wave_friend = " 👋 打个招呼 ";
$lang_get_profile_actions_message_friend = " 💬 信息 ";
$lang_get_profile_edit = "编辑"; 
$lang_get_profile_add_friend = "加好友";
$lang_get_profile_delete_friend = "删除好友";
$lang_get_profile_add_request = "加";
$lang_get_profile_deny_request = "拒绝";
$lang_get_profile_requested = "请求";
$lang_get_profile_your_info = "关于你 ";
$lang_get_profile_info = "信息";
$lang_get_profile_thisaccount_isprivate = "🔒 这是个私人账号 ";
$lang_get_profile_joined = " 💭 加入 ";
$lang_get_profile_birthday = " 生日 ";
$lang_get_profile_location = " 🌎 地区 ";
$lang_get_profile_privateaccount = " 🔒 私人账号 ";
$lang_get_profile_yourfriends = "你的好友 • ";
$lang_get_profile_theirfriends = "ta们的好友 • ";
$lang_get_profile_theirfriendsnodot = "ta们的好友 ";
$lang_get_profile_incommon1 = " 你有 ";
$lang_get_profile_incommon2 = " 共同好友. ";
$lang_get_profile_noneincommon = " 你们并没有共同好友. ";
$lang_get_profile_yourposts = "你的帖子 • ";
$lang_get_profile_posts = "帖子 • ";
$lang_get_profile_postsnodot = "帖子 ";
$lang_get_profile_likedposts = "喜欢的帖子";

$lang_header_notifications = "通知 •";
$lang_header_msgs = "信息 • "; 
$lang_header_friendsreqs = "好友请求 •";
$lang_header_search = " 搜索 ";
$lang_header_search_users = " 用户";
$lang_header_dropdown_settings = "⚙️ 设置 ";
$lang_header_dropdown_findfriends = "🍀 找新的好友";
$lang_header_dropdown_language = "🌍 语言 ";
$lang_header_dropdown_logout = "🚪 登出 ";
$lang_header_head_home = "主页 " ;
$lang_header_head_invite = "邀请" ;
$lang_header_head_more = "更多";

$lang_header_new_signin = " 登入 ";
$lang_header_new_signup = " 注册 ";

$lang_internetalive1 = "哎呀... 🔌";
$lang_internetalive2 = "您不在线，请检查您的互联网连接，然后重试. ";
$lang_internetalive3 = "很期待下次再见！. ";

$lang_notifsfetch_none = " 💭 没有新消息 "; 

$lang_post_whatwouldulike = "你要发些什么呢？, ";
$lang_post_upload = "上传";
$lang_post_addloc = "🌎 添加位置 ";

$lang_postfetch_theirpostsareprivate = " 🔒 您无法查看这个私人账号的帖子，请先加为好友。";
$lang_postfetch_nomoremakefriend = " 💭 没有新的帖子！请先加更多的好友，才有新的帖子喔！";
$lang_postfetch_nonefound = " 💭 没有新的帖子. ";

$lang_requestsfetch_nofound = " 💭 没有新的请求 ";

$lang_searchajax_friend = " 好友 ";
$lang_searchajax_viewmore = " 查看 "; 
$lang_searchajax_viewmore2 = " 更多结果… (edit?) ";

$lang_suggestedfriends_nosuggestions = " 💭 目前找不到任何建议 (edit?). ";
