<?php 
$lang_core_html_titles_search = "Szukaj";
$lang_core_html_titles_friends = "Przyjaciele";
$lang_core_html_titles_index = "Strona główna";
$lang_core_html_titles_invite = "Zaprasza";
$lang_core_html_titles_language = "Języki";
$lang_core_html_titles_profile = "Profil";
$lang_core_html_titles_settings = "Ustawienia";
$lang_core_html_titles_about = "Informacje";

$lang_core_friends_makefriends = "Znajdź przyjaciół";

$lang_core_index_trending = "Na czasie 🔥";
$lang_core_index_trending_desc = "Aktualne trendy:";
$lang_core_index_publicrooms = "Pokoje publiczne";
$lang_core_index_friends = "Przyjaciele";
$lang_core_index_suggestedfriends = "Sugerowani znajomi";
$lang_core_index_posts = "Posty";

$lang_core_profile_notexist = "🚫 To konto nie istnieje";

$lang_core_searchpage_search = "Szukaj";

$lang_core_about_editedlast = "Edytowano 2021/03 · MojaStrona © 2021";

$lang_core_about_about = "Informacje";
$lang_core_about_about_desc = "Media społecznościowe stworzone przez Adriana.";
$lang_core_about_support = "Wsparcie";
$lang_core_about_support_desc = "Aby uzyskać pomoc, skontaktuj się z support@mypage.com";
$lang_core_about_new = "Co nowego";
$lang_core_about_new_desc = "Języki";
$lang_core_about_safety = "Bezpieczeństwo";
$lang_core_about_safety_desc = "Możesz blokować ludzi.";
$lang_core_about_privacy = "Prywatność";
$lang_core_about_privacy_desc = "Używamy szyfrowania, aby Twoje dane były bezpieczne.";
$lang_core_about_terms = "Warunki";
$lang_core_about_terms_desc = "Symbol zastępczy regulaminu.";
$lang_core_about_cookies = "Ciasteczka";
$lang_core_about_cookies_desc = "Używamy niezbędnych plików cookie, takich jak automatyczne logowanie, aby zapewnić dobre wrażenia z korzystania z witryny.";

$lang_core_settings_title = "Ustawienia";
$lang_core_settings_desc = "Zarządzaj ustawieniami tutaj.";
$lang_core_settings_account = "👤 Konto";
$lang_core_settings_privacy = "🔒 Prywatność"; 
$lang_core_settings_appearance = "🦋 Wygląd"; 
$lang_core_settings_blockedusers = "🚫 Zablokowani użytkownicy";
$lang_core_settings_blockedwords = "🚫 Zablokowane słowa";
$lang_core_settings_notifications = "🔔 Powiadomienia";
$lang_core_settings_features = "🛠 Funkcje";

$lang_core_settings_account_title = "Konto";
$lang_core_settings_account_desc = "Zobacz tutaj ustawienia swojego konta.";
$lang_core_settings_privacy_title = "Prywatność";
$lang_core_settings_privacy_desc = "Wyświetl tutaj swoje ustawienia prywatności.";
$lang_core_settings_appearance_title = "Wygląd";
$lang_core_settings_appearance_desc = "Zobacz tutaj swoje ustawienia wyglądu.";
$lang_core_settings_blockedusers_title = "Zablokowani użytkownicy"; 
$lang_core_settings_blockedusers_desc = "Zobacz tutaj swoich zablokowanych użytkowników."; 
$lang_core_settings_blockedwords_title = "Zablokowane słowa";
$lang_core_settings_blockedwords_desc = "Wyświetl tutaj zablokowane słowa.";
$lang_core_settings_notifs_title = "Powiadomienia";
$lang_core_settings_notifs_desc = "Wyświetl tutaj ustawienia powiadomień.";
$lang_core_settings_features_title = "Funkcje";
$lang_core_settings_features_desc = "Zobacz tutaj ustawienia funkcji.";

$lang_core_settings_changeprivacy = "Zmień swój profil na prywatny lub publiczny"; 
$lang_core_settings_changeprivacy_on = "Przełącz na profil prywatny"; 
$lang_core_settings_changeprivacy_off = "Przełącz na profil publiczny"; 

$lang_core_language_displaylang = "🌎 Język wyświetlania"; 

$lang_core_settings_on = "Włącz";
$lang_core_settings_off = "Wył.";

// Koniec rdzenia

$lang_just_now = "przed chwilą";

$lang_about_about = "Informacje";
$lang_about_support = "Wsparcie";
$lang_about_safety = "Bezpieczeństwo";
$lang_about_privacy = "Prywatność";
$lang_about_terms = "Warunki";
$lang_about_cookies = "Ciasteczka";
$lang_about_copyright = "· MyPage © 2021";

$lang_fetch_blocked_none = "💭 Jeszcze nikogo nie zablokowałeś."; 

$lang_fetch_invites_header_reach_limit = "Zaproś znajomych • Pozostało 0";
$lang_fetch_invites_header = "Zaproś znajomych •";
$lang_fetch_invites_header2 = "w lewo"; 
$lang_fetch_invites_desc_reach_limit = "Osiągnąłeś limit zaproszeń wynoszący 20. Wróć później i zaproś więcej osób."; 
$lang_fetch_invites_desc = "Mypage tylko na zaproszenie w tej chwili, więc upewnij się, że wygenerowałeś kody zaproszeniowe dla swoich przyjaciół, abyś mógł ich zaprosić.";  
$lang_fetch_invites_usedby = "Używany przez"; 
$lang_fetch_invites_unused = "Kod nieużywany";
$lang_fetch_invites_generatecode = "Wygeneruj kod ✉️";

$lang_friends_fetch_cantseetheirfriends = "🔒 Nie możesz zobaczyć ich przyjaciół.";
$lang_friends_fetch_nofriendsfound = "🚫 Nie znaleziono przyjaciół";
$lang_friends_fetch_you = "Ty";
$lang_friends_fetch_friend = "przyjaciel";

$lang_get_profile_actions = "Działania";
$lang_get_profile_actions_remove_friend = "❌ Usuń znajomego";
$lang_get_profile_actions_block_friend = "🚫 Blokuj";
$lang_get_profile_actions_love_friend = "❤️ Miłość Prośba";
$lang_get_profile_actions_wave_friend = "👋 Wave";
$lang_get_profile_actions_message_friend = "💬 Wiadomość";
$lang_get_profile_edit = "Edytuj"; 
$lang_get_profile_add_friend = "Dodaj znajomego";
$lang_get_profile_delete_friend = "Usuń znajomego";
$lang_get_profile_add_request = "Dodaj";
$lang_get_profile_deny_request = "Odmów";
$lang_get_profile_requested = "Żądane";
$lang_get_profile_your_info = "Twoje dane";
$lang_get_profile_info = "Informacje";
$lang_get_profile_thisaccount_isprivate = "🔒 To konto jest prywatne";
$lang_get_profile_joined = "💭 dołączył";
$lang_get_profile_birthday = "Urodziny";
$lang_get_profile_location = "🌎 Lokalizacja";
$lang_get_profile_privateaccount = "🔒 Konto prywatne";
$lang_get_profile_yourfriends = "Twoi znajomi •";
$lang_get_profile_theirfriends = "Ich przyjaciele •";
$lang_get_profile_theirfriendsnodot = "Ich przyjaciele";
$lang_get_profile_incommon1 = "Masz";
$lang_get_profile_incommon2 = "wspólni znajomi.";
$lang_get_profile_noneincommon = "Nie masz wspólnych przyjaciół.";
$lang_get_profile_yourposts = "Twoje posty •";
$lang_get_profile_posts = "Posty •";
$lang_get_profile_postsnodot = "Posty";
$lang_get_profile_likedposts = "Lubiane posty";

$lang_header_notifications = "Powiadomienia •";
$lang_header_msgs = "Wiadomości •"; 
$lang_header_friendsreqs = "Zaproszenia do znajomych •";
$lang_header_search = "Szukaj";
$lang_header_search_users = "użytkownicy";
$lang_header_dropdown_settings = "⚙️ Ustawienia";
$lang_header_dropdown_findfriends = "🍀 Znajdź przyjaciół";
$lang_header_dropdown_language = "🌍 Język";
$lang_header_dropdown_logout = "🚪 Wyloguj się";
$lang_header_head_home = "Strona główna";
$lang_header_head_invite = "Zaproś";
$lang_header_head_more = "Więcej";

$lang_header_new_signin = "Zaloguj się";
$lang_header_new_signup = "Zarejestruj się";

$lang_internetalive1 = "Ups ... 🔌";
$lang_internetalive2 = "Jesteś offline, sprawdź swoje połączenie internetowe.";
$lang_internetalive3 = "Do zobaczenia wkrótce.";

$lang_notifsfetch_none = "💭 Nie znaleziono powiadomień"; 

$lang_post_whatwouldulike = "Co chcesz opublikować";
$lang_post_upload = "Prześlij";
$lang_post_addloc = "🌎 Dodaj lokalizację";

$lang_postfetch_theirpostsareprivate = "🔒 Ich posty są prywatne. Najpierw dodaj ich jako przyjaciela.";
$lang_postfetch_nomoremakefriend = "💭 Nie znaleziono więcej postów! Poznaj nowych przyjaciół i znajdź więcej.";
$lang_postfetch_nonefound = "💭 Nie znaleziono więcej postów.";

$lang_requestsfetch_nofound = "💭 Nie znaleziono żądań";

$lang_searchajax_friend = "Przyjaciel";
$lang_searchajax_viewmore = "Wyświetl"; 
$lang_searchajax_viewmore2 = "więcej wyników ...";

$lang_suggestedfriends_nosuggestions = "💭 W tej chwili nie można znaleźć żadnych sugestii.";
