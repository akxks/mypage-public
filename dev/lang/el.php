<?php
$lang_core_html_titles_search = "Αναζήτηση";
$lang_core_html_titles_friends = "Φίλοι";
$lang_core_html_titles_index = "Home";
$lang_core_html_titles_invite = "Προσκλήσεις";
$lang_core_html_titles_language = "Γλώσσες";
$lang_core_html_titles_profile = "Προφίλ";
$lang_core_html_titles_settings = "Ρυθμίσεις";
$lang_core_html_titles_about = "Πληροφορίες";

$lang_core_friends_makefriends = "Κάντε φίλους";

$lang_core_index_trending = "Trending 🔥";
$lang_core_index_trending_desc = "Currenty Trending:";
$lang_core_index_publicrooms = "Δημόσια δωμάτια";
$lang_core_index_friends = "Φίλοι";
$lang_core_index_suggestedfriends = "Προτεινόμενοι φίλοι";
$lang_core_index_posts = "Δημοσιεύσεις";

$lang_core_profile_notexist = " 🚫 Αυτός ο λογαριασμός δεν υπάρχει ";

$lang_core_searchpage_search = "Αναζήτηση";

$lang_core_about_editedlast = "Edited 2021/03 - MyPage © 2021";

$lang_core_about_about = "About";
$lang_core_about_about_desc = "Social media created by Adrian.";
$lang_core_about_support = "Υποστήριξη";
$lang_core_about_support_desc = "Για υποστήριξη; επικοινωνήστε με το support@mypage.com";
$lang_core_about_new = "Whats new";
$lang_core_about_new_desc = "Γλώσσες";
$lang_core_about_safety = "Ασφάλεια";
$lang_core_about_safety_desc = "Μπορείτε να μπλοκάρετε άτομα.";
$lang_core_about_privacy = "Ιδιωτικότητα";
$lang_core_about_privacy_desc = "Χρησιμοποιούμε κρυπτογράφηση ώστε τα δεδομένα σας να είναι ασφαλή.";
$lang_core_about_terms = "Όροι";
$lang_core_about_terms_desc = "Όροι και προϋποθέσεις placeholder.";
$lang_core_about_cookies = "Cookies";
$lang_core_about_cookies_desc = "Χρησιμοποιούμε βασικά cookies; όπως το Auto Login; για να διατηρήσουμε την εμπειρία σας με τον ιστότοπο καλή.";

$lang_core_settings_title = "Ρυθμίσεις";
$lang_core_settings_desc = "Διαχείριση των ρυθμίσεων εδώ.";
$lang_core_settings_account = "👤 Λογαριασμός";
$lang_core_settings_privacy = "🔒 Απόρρητο"; 
$lang_core_settings_appearance = "🦋 Εμφάνιση"; 
$lang_core_settings_blockedusers = "🚫 Αποκλεισμένοι χρήστες";
$lang_core_settings_blockedwords = "🚫 Αποκλεισμένες λέξεις";
$lang_core_settings_notifications = "🔔 Ειδοποιήσεις";
$lang_core_settings_features = "🛠 Χαρακτηριστικά";

$lang_core_settings_account_title = "Λογαριασμός";
$lang_core_settings_account_desc = "Δείτε τις ρυθμίσεις του λογαριασμού σας εδώ. ";
$lang_core_settings_privacy_title = "Απόρρητο";
$lang_core_settings_privacy_desc = "Δείτε τις ρυθμίσεις απορρήτου σας εδώ. ";
$lang_core_settings_appearance_title = "Εμφάνιση";
$lang_core_settings_appearance_desc = "View your appearance settings here.";
$lang_core_settings_blockedusers_title = "Αποκλεισμένοι χρήστες"; 
$lang_core_settings_blockedusers_desc = "View your blocked users here."; 
$lang_core_settings_blockedwords_title = "Αποκλεισμένες λέξεις";
$lang_core_settings_blockedwords_desc = "View blocked words here.";
$lang_core_settings_notifs_title = "Ειδοποιήσεις";
$lang_core_settings_notifs_desc = "View notifications settings here.";
$lang_core_settings_features_title = "Χαρακτηριστικά";
$lang_core_settings_features_desc = "Προβολή ρυθμίσεων χαρακτηριστικών εδώ.";

$lang_core_settings_changeprivacy = " Αλλαγή του προφίλ σας σε ιδιωτικό ή δημόσιο "; 
$lang_core_settings_changeprivacy_on = " Εναλλαγή σε ιδιωτικό προφίλ "; 
$lang_core_settings_changeprivacy_off = " Εναλλαγή σε δημόσιο προφίλ "; 

$lang_core_language_displaylang = " 🌎 Γλώσσα εμφάνισης "; 

$lang_core_settings_on = "On";
$lang_core_settings_off = "Off";

// Τέλος πυρήνα

$lang_just_now = "μόλις τώρα";

$lang_about_about = "About";
$lang_about_support = "Υποστήριξη";
$lang_about_safety = "Ασφάλεια";
$lang_about_privacy = "Προστασία προσωπικών δεδομένων";
$lang_about_terms = "Όροι";
$lang_about_cookies = "Cookies";
$lang_about_copyright = "- MyPage © 2021 ";

$lang_fetch_blocked_none = "💭 Δεν έχετε μπλοκάρει κανέναν ακόμα."; 

$lang_fetch_invites_header_reach_limit = "Πρόσκληση φίλων - 0 αριστερά";
$lang_fetch_invites_header = "Πρόσκληση φίλων - ";
$lang_fetch_invites_header2 = "left"; 
$lang_fetch_invites_desc_reach_limit = "Έχετε φτάσει στο όριο των 20 προσκλήσεων. Παρακαλείσθε να επανέλθετε αργότερα και να προσκαλέσετε περισσότερα άτομα."; 
$lang_fetch_invites_desc = "Mypage invite-only right now; οπότε φροντίστε να δημιουργήσετε κωδικούς πρόσκλησης στους φίλους σας; ώστε να μπορείτε να τους προσκαλέσετε.  ";  
$lang_fetch_invites_usedby = " Used by "; 
$lang_fetch_invites_unused = " Κωδικός που δεν χρησιμοποιείται ";
$lang_fetch_invites_generatecode = "Δημιουργήστε έναν κωδικό ✉️";

$lang_friends_fetch_cantseetheirfriends = "🔒 Δεν μπορείτε να δείτε τους φίλους τους. ";
$lang_friends_fetch_nofriendsfound = "🚫 Δεν βρέθηκαν φίλοι ";
$lang_friends_fetch_you = " You ";
$lang_friends_fetch_friend = " friend";

$lang_get_profile_actions = " Ενέργειες ";
$lang_get_profile_actions_remove_friend = " ❌ Αφαίρεση φίλου ";
$lang_get_profile_actions_block_friend = " 🚫 Block ";
$lang_get_profile_actions_love_friend = " ❤️ Αίτημα αγάπης ";
$lang_get_profile_actions_wave_friend = " 👋 Wave ";
$lang_get_profile_actions_message_friend = " 💬 Μήνυμα ";
$lang_get_profile_edit = "Επεξεργασία"; 
$lang_get_profile_add_friend = "Προσθήκη φίλου";
$lang_get_profile_delete_friend = "Διαγραφή φίλου";
$lang_get_profile_add_request = "Προσθήκη";
$lang_get_profile_deny_request = "Deny";
$lang_get_profile_requested = "Ζητήθηκε";
$lang_get_profile_your_info = "Your Info ";
$lang_get_profile_info = "Πληροφορίες ";
$lang_get_profile_thisaccount_isprivate = "🔒 This account is private ";
$lang_get_profile_joined = " 💭 Joined ";
$lang_get_profile_birthday = " Birthday ";
$lang_get_profile_location = " 🌎 Τοποθεσία ";
$lang_get_profile_privateaccount = " 🔒 Ιδιωτικός λογαριασμός ";
$lang_get_profile_yourfriends = "Οι φίλοι σας - ";
$lang_get_profile_theirfriends = "Οι φίλοι τους - ";
$lang_get_profile_theirfriendsnodot = "Οι φίλοι τους ";
$lang_get_profile_incommon1 = " Έχετε ";
$lang_get_profile_incommon2 = " κοινούς φίλους. ";
$lang_get_profile_noneincommon = " Δεν έχετε κοινούς φίλους. ";
$lang_get_profile_yourposts = "Your Posts - ";
$lang_get_profile_posts = "Posts - ";
$lang_get_profile_postsnodot = "Posts ";
$lang_get_profile_likedposts = "Αγαπημένες αναρτήσεις";

$lang_header_notifications = "Ειδοποιήσεις -";
$lang_header_msgs = "Μηνύματα - "; 
$lang_header_friendsreqs = "Αιτήσεις φιλίας -";
$lang_header_search = " Αναζήτηση ";
$lang_header_search_users = "users";
$lang_header_dropdown_settings = "⚙️ Ρυθμίσεις ";
$lang_header_dropdown_findfriends = "🍀 Εύρεση φίλων";
$lang_header_dropdown_language = "🌍 Γλώσσα ";
$lang_header_dropdown_logout = "🚪 Logout ";
$lang_header_head_home = "Home" ;
$lang_header_head_invite = "Πρόσκληση" ;
$lang_header_head_more = "Περισσότερα";

$lang_header_new_signin = " Sign In ";
$lang_header_new_signup = " Sign Up ";

$lang_internetalive1 = "Uh oh... 🔌";
$lang_internetalive2 = "Είστε εκτός σύνδεσης; ελέγξτε τη σύνδεσή σας στο διαδίκτυο. ";
$lang_internetalive3 = "Ελπίζω να σας δω σύντομα. ";

$lang_notifsfetch_none = " 💭 Δεν βρέθηκαν ειδοποιήσεις "; 

$lang_post_whatwouldulike = "Τι θα θέλατε να δημοσιεύσετε; ";
$lang_post_upload = "Ανέβασμα";
$lang_post_addloc = "🌎 Προσθήκη τοποθεσίας ";

$lang_postfetch_theirpostsareprivate = " 🔒 Οι δημοσιεύσεις τους είναι ιδιωτικές. Προσθέστε τους πρώτα ως φίλους. ";
$lang_postfetch_nomoremakefriend = " 💭 Δεν βρέθηκαν άλλες αναρτήσεις! Κάντε νέους φίλους και βρείτε περισσότερες.";
$lang_postfetch_nonefound = " 💭 Δεν βρέθηκαν άλλες αναρτήσεις. ";

$lang_requestsfetch_nofound = " 💭 Δεν βρέθηκαν άλλα αιτήματα" ;

$lang_searchajax_friend = " Friend ";
$lang_searchajax_viewmore = " Προβολή "; 
$lang_searchajax_viewmore2 = " περισσότερα αποτελέσματα... ";

$lang_suggestedfriends_nosuggestions = " 💭 Δεν μπόρεσε να βρει προτάσεις αυτή τη στιγμή. ";
