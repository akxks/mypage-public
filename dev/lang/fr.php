<?php
$lang_core_html_titles_search = "Recherche" ;
$lang_core_html_titles_friends = "Amis" ;
$lang_core_html_titles_index = "Accueil" ;
$lang_core_html_titles_invite = "Invites" ;
$lang_core_html_titles_language = "Langues" ;
$lang_core_html_titles_profile = "Profil" ;
$lang_core_html_titles_settings = "Paramètres" ;
$lang_core_html_titles_about = "About" ;

$lang_core_friends_makefriends = "Se faire des amis" ;

$lang_core_index_trending = "Trending 🔥" ;
$lang_core_index_trending_desc = "Currenty Trending :";
$lang_core_index_publicrooms = "Salles publiques" ;
$lang_core_index_friends = "Amis" ;
$lang_core_index_suggestedfriends = "Amis suggérés" ;
$lang_core_index_posts = "Messages" ;

$lang_core_profile_notexist = " 🚫 Ce compte n'existe pas " ;

$lang_core_searchpage_search = "Recherche" ;

$lang_core_about_editedlast = "Edited 2021/03 - MyPage © 2021" ;

$lang_core_about_about = "A propos" ;
$lang_core_about_about_desc = "Médias sociaux créés par Adrian" ;
$lang_core_about_support = "Support" ;
$lang_core_about_support_desc = "Pour obtenir de l'aide, contactez support@mypage.com" ;
$lang_core_about_new = "Quoi de neuf" ;
$lang_core_about_new_desc = "Langues" ;
$lang_core_about_safety = "Sécurité" ;
$lang_core_about_safety_desc = "Tu peux bloquer des personnes" ;
$lang_core_about_privacy = "Vie privée" ;
$lang_core_about_privacy_desc = "Nous utilisons le cryptage pour que vos données soient sécurisées" ;
$lang_core_about_terms = "Conditions" ;
$lang_core_about_terms_desc = "Terms and conditions placeholder" ;
$lang_core_about_cookies = "Cookies" ;
$lang_core_about_cookies_desc = "Nous utilisons des cookies essentiels, tels que la connexion automatique, pour que votre expérience du site Web reste bonne." ;

$lang_core_settings_title = "Paramètres" ;
$lang_core_settings_desc = "Gérer les paramètres ici" ;
$lang_core_settings_account = "👤 Compte" ;
$lang_core_settings_privacy = "🔒 Privacy" ; 
$lang_core_settings_appearance = "🦋 Appearance" ; 
$lang_core_settings_blockedusers = "🚫 Blocked Users" ;
$lang_core_settings_blockedwords = "🚫 Blocked Words" ;
$lang_core_settings_notifications = "🔔 Notifications" ;
$lang_core_settings_features = "🛠 Features" ;

$lang_core_settings_account_title = "Compte" ;
$lang_core_settings_account_desc = "Afficher les paramètres de votre compte ici. " ;
$lang_core_settings_privacy_title = "Vie privée" ;
$lang_core_settings_privacy_desc = "Affichez vos paramètres de confidentialité ici. " ;
$lang_core_settings_appearance_title = "Apparence" ;
$lang_core_settings_appearance_desc = "Affichez vos paramètres d'apparence ici." ;
$lang_core_settings_blockedusers_title = "Utilisateurs bloqués" ; 
$lang_core_settings_blockedusers_desc = "Afficher vos utilisateurs bloqués ici" ; 
$lang_core_settings_blockedwords_title = "Mots bloqués" ;
$lang_core_settings_blockedwords_desc = "Afficher les mots bloqués ici" ;
$lang_core_settings_notifs_title = "Notifications" ;
$lang_core_settings_notifs_desc = "Afficher les paramètres des notifications ici" ;
$lang_core_settings_features_title = "Caractéristiques" ;
$lang_core_settings_features_desc = "Afficher les paramètres des fonctionnalités ici" ;

$lang_core_settings_changeprivacy = "Changez votre profil en privé ou en public" ; 
$lang_core_settings_changeprivacy_on = " Passez à un profil privé " ; 
$lang_core_settings_changeprivacy_off = " Passez à un profil public " ; 

$lang_core_language_displaylang = " 🌎 Langue d'affichage " ; 
...
$lang_just_now = "juste maintenant" ;

$lang_about_about = "À propos" ;
$lang_about_support = "Support" ;
$lang_about_safety = "Sécurité" ;
$lang_about_privacy = "Confidentialité" ;
$lang_about_terms = "Conditions" ;
$lang_about_cookies = "Cookies" ;
$lang_about_copyright = "- MyPage © 2021 " ;

$lang_fetch_blocked_none = "💭 Vous n'avez encore bloqué personne." ; 

$lang_fetch_invites_header_reach_limit = "Invite Friends - 0 left" ;
$lang_fetch_invites_header = "Invite Friends - " ;
$lang_fetch_invites_header2 = "left" ; 
$lang_fetch_invites_desc_reach_limit = "Vous avez atteint la limite d'invitation de 20 personnes. Veuillez revenir plus tard pour inviter d'autres personnes." ; 
...
$lang_fetch_invites_usedby = " Utilisé par " ; 
$lang_fetch_invites_unused = " Code non utilisé " ;
$lang_fetch_invites_generatecode = "Générer un code ✉️" ;

$lang_friends_fetch_cantseetheirfriends = "🔒 Vous ne pouvez pas voir leurs amis. " ;
$lang_friends_fetch_nofriendsfound = "🚫 Aucun ami trouvé " ;
$lang_friends_fetch_you = " Vous " ;
$lang_friends_fetch_friend = " ami " ;

$lang_get_profile_actions = " Actions " ;
$lang_get_profile_actions_remove_friend = " ❌ Supprimer un ami " ;
$lang_get_profile_actions_block_friend = " 🚫 Block " ;
$lang_get_profile_actions_love_friend = " ❤️ Love Request " ;
$lang_get_profile_actions_wave_friend = " 👋 Wave " ;
$lang_get_profile_actions_message_friend = " 💬 Message " ;
$lang_get_profile_edit = "Edit" ; 
$lang_get_profile_add_friend = "Ajouter un ami" ;
$lang_get_profile_delete_friend = "Supprimer un ami" ;
$lang_get_profile_add_request = "Ajouter" ;
$lang_get_profile_deny_request = "Refuser" ;
$lang_get_profile_requested = "Requested" ;
$lang_get_profile_your_info = "Your Info " ;
$lang_get_profile_info = "Info " ;
$lang_get_profile_thisaccount_isprivate = "🔒 Ce compte est privé " ;
$lang_get_profile_joined = " 💭 Joined " ;
$lang_get_profile_birthday = " Birthday " ;
$lang_get_profile_location = " 🌎 Location " ;
$lang_get_profile_privateaccount = " 🔒 Compte privé " ;
$lang_get_profile_yourfriends = "Vos amis - " ;
$lang_get_profile_theirfriends = "Leurs amis - " ;
$lang_get_profile_theirfriendsnodot = "Leurs amis" ;
$lang_get_profile_incommon1 = " Vous avez " ;
$lang_get_profile_incommon2 = " des amis en commun. " ;
$lang_get_profile_noneincommon = " Vous n'avez pas d'amis en commun. " ;
$lang_get_profile_yourposts = "Vos messages - " ;
$lang_get_profile_posts = "Messages - " ;
$lang_get_profile_postsnodot = "Messages " ;
$lang_get_profile_likedposts = "Messages aimés" ;

$lang_header_notifications = "Notifications -" ;
$lang_header_msgs = "Messages - " ; 
$lang_header_friendsreqs = "Demandes d'amis -" ;
$lang_header_search = "Recherche" ;
$lang_header_search_users = "users" ;
$lang_header_dropdown_settings = "⚙️ Paramètres " ;
$lang_header_dropdown_findfriends = "🍀 Find Friends" ;
$lang_header_dropdown_language = "🌍 Language " ;
$lang_header_dropdown_logout = "🚪 Logout " ;
$lang_header_head_home = "Home" ;
$lang_header_head_invite = "Invite" ;
$lang_header_head_more = "More" ;

$lang_header_new_signin = "Sign In" ;
$lang_header_new_signup = "Sign Up" ;

$lang_internetalive1 = "Uh oh... 🔌" ;
$lang_internetalive2 = "Vous êtes hors ligne, vérifiez votre connexion internet. " ;
$lang_internetalive3 = "J'espère vous voir bientôt. " ;

$lang_notifsfetch_none = " 💭 Aucune notification trouvée " ; 

$lang_post_whatwouldulike = "Qu'aimeriez-vous poster, " ;
$lang_post_upload = "Télécharger" ;
$lang_post_addloc = "🌎 Add Location " ;

$lang_postfetch_theirpostsareprivate = " 🔒 Leurs messages sont privés. Ajoutez-les d'abord comme ami. " ;
$lang_postfetch_nomoremakefriend = " 💭 Aucun autre message trouvé ! Faites-vous de nouveaux amis et trouvez-en d'autres. " ;
$lang_postfetch_nonefound = " 💭 Plus aucun message trouvé. " ;

$lang_requestsfetch_nofound = " 💭 Aucune demande trouvée " ;

$lang_searchajax_friend = " Ami " ;
$lang_searchajax_viewmore = " Voir " ; 
$lang_searchajax_viewmore2 = " Plus de résultats... " ;

$lang_suggestedfriends_nosuggestions = " 💭 Impossible de trouver des suggestions pour le moment. " ; 
